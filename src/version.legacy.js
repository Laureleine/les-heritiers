// src/version.legacy.js
// Archives historiques — non importé par l'application, conservé pour mémoire.
// Contient toutes les versions antérieures à 15.12.0.

export const VERSION_HISTORY_LEGACY = [
    {
