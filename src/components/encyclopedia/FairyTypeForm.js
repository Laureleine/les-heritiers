...
const FairyTypeForm = ({
    ...
    const handleListKeyDown = useCallback((e, field) => {
        if (e.key === 'Enter') {
            ...
            // Astuce React : on replace le curseur après le re-rendu
            setTimeout(() => {
                if (target) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <textarea
                        ...
                        onKeyDown={(e) => handleListKeyDown(e, 'avantages')}
                ...
                <div>
                    ...
                    <textarea
                        ...
                        onKeyDown={(e) => handleListKeyDown(e, 'desavantages')}
