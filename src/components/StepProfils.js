...
export default function StepProfils({ character, onProfilsChange }) {
  ...
  const handleProfilMajeurChange = (profil) => {
    onProfilsChange({
      ...
      majeur: {
        ...
        competences: profils[profil].competences
      }
    });
  };
  ...
  const renderProfilCard = (profilName, isSelected, isMajeur, onSelect) => {
    const profilData = profils[profilName];
        ...
        {profilMajeur && (
          <div className="mt-4 p-4 bg-white rounded-lg border-2 border-amber-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {profils[profilMajeur].traits.map(trait => (
                <button
                  key={trait}
      ...
      <div className="border-2 border-blue-300 rounded-lg p-6 bg-gradient-to-br from-blue-50 to-sky-50">
        ...
        {profilMineur && (
          <div className="mt-4 p-4 bg-white rounded-lg border-2 border-blue-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {profils[profilMineur].traits.map(trait => (
                <button
                  key={trait}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-amber-700 mt-1">
                  Compétences à +2 : {profils[profilMajeur].competences.join(', ')}
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-blue-700 mt-1">
                  Compétences à +1 : {profils[profilMineur].competences.join(', ')}
                </div>
              </div>
            </div>
          </div>
