    ...
    <div className="min-h-screen bg-amber-50 py-10 px-4">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-2xl border border-amber-100 overflow-hidden">
        ...
        <main className="p-8 md:p-12">
          ...
          {step === 1 && <Step1 character={character} onNomChange={(n) => setCharacter({...character, nom: n})} onSexeChange={(s) => setCharacter({...character, sexe: s})} onTypeFeeChange={(t) => setCharacter({...character, typeFee: t, anciennete: getFairyAge(t, 'traditionnelle', gameData.fairyData)})} fairyTypesByAge={gameData.fairyTypesByAge} />}
