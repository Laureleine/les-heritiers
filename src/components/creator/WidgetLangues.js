...
export default function WidgetLangues({ character, dispatchCharacter, gameData, isReadOnly }) {
  ...
  const boughtItems = gameData?.socialItems?.filter(i => allBoughtIds.includes(i.id) && i.categorie === 'langue') || [];
  ...
  // ==========================================================================
  return (
    <div className="bg-white rounded-xl shadow-md border-2 border-blue-300 overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 mt-8 animate-fade-in">
      
      {/* EN-TÊTE */}
      <div className="flex items-center justify-between p-4 border-b border-blue-200 bg-white/50">
