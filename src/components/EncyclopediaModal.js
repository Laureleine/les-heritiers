...
export default function EncyclopediaModal({
  ...
  // 🧠 ÉTATS LOCAUX PURIFIÉS (Plus de barres de recherche ici !)
  ...
  // ✨ GESTIONNAIRE DE FORGE RAPIDE (Poupée Russe)
  ...
  // 🚀 SOUMISSION AU CONSEIL (Déléguée au Moteur)
    ...
    <div className="fixed inset-0 bg-stone-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-fade-in">
        ...
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-stone-50 shrink-0">
          ...
          <button onClick={() => setEditingItem(null)} className="text-gray-400 hover:text-gray-600 transition-colors p-2 bg-white rounded-full shadow-sm">
            <X size={20} />
          </button>
        </div>
