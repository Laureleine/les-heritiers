...
// Version: 3.0.2
// Build: 2026-02-04 03:00
// Description: Panel admin - Validation des modifications et paramètres
...
export default function ValidationsPendantes({ session, onBack, isAdmin }) {
  ...
  const toggleDataEditor = async () => {
    ...
    alert(`Bouton DataEditor ${newValue ? 'activé' : 'désactivé'} pour tous les utilisateurs`);
  };
          ...
          <div className="flex justify-between items-center mb-6 pb-4 border-b-2 border-amber-200">
            <div>
              ...
              <p className="text-amber-700 mt-1">
                Approuvez ou rejetez les modifications proposées
              </p>
            </div>
            <button
              onClick={onBack}
