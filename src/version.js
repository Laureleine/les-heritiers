...
export const VERSION_HISTORY = [
  ...
  },
  {
    ...
    changes: [
      ...
      "🕯️ **224 révélations pré-remplies**, couvrant 21 mystères.",
  ...
  },
  {
    ...
    changes: [
      '🔥 **Animations `fade-in*` ressuscitées :** 124 classes Tailwind `*` flottaient dans le vide — aucune keyframes définie. Les transitions d\'entrée de tous les composants sont désormais réelles : fondu, glissement vers le haut et vers le bas fonctionnent enfin.',
