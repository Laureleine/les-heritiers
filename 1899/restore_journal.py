...
FEUILLETON_PARAGRAPHS = [
    ...
    "— Expliquez-vous. Il s'expliqua difficilement, car les larmes redoublaient, mais Colette, attentive, et Jeannette comprirent l'une et l'autre : ils étaient partis comme d'habitude le matin, de bonne heure, Gilbert avec son violon et Lucien portant sa harpe. C'était dimanche, la recette avait été bonne ; ils avaient récolté quelques sous.",
    ...
    "Un homme était là, déguenillés, ivre, jurant et chantant, qui brisait à coups de talon, avec une joie féroce et bête, le violon de Gilbert, devenu un amas de débris, et la harpe de Lucien, qui, sous chacun des coups, rendait des sons tristes et plaintifs, comme si elle avait souffert vraiment et comme si elle avait été douée d'une âme. La harpe et le violon n'existaient plus."
]
...
def restore_data():
    ...
    for art in articles:
        ...
        for idx_p, p in enumerate(art["paragraphs"]):
            ...
            # Article 19 : Madagascar (Spécifique)
            if art_id == 19:
