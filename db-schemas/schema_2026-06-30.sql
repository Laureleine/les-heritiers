...
\restrict fKpVhPQayBkYkYblq2z31D7RbE8LQ6agPyDejTg7itDa5dxZPdInR8msxpbLKqm
...
CREATE TABLE public.pnj_table_entries (
    ...
    CONSTRAINT pnj_table_entries_table_name_check CHECK ((table_name = ANY (ARRAY['traits'::text, 'apparences'::text, 'motivations'::text, 'secrets'::text, 'phobies'::text, 'hobbies'::text, 'comportements'::text, 'metiers'::text]))),
...
\unrestrict fKpVhPQayBkYkYblq2z31D7RbE8LQ6agPyDejTg7itDa5dxZPdInR8msxpbLKqm
